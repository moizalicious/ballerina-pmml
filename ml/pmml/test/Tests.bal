...
function testIsValid () {
    xml pmml = pmml:readFileAsXML("ml/pmml/test/res/LinearRegression.pmml");
...
function testPolynomialRegression () {
    xml pmml = pmml:readFileAsXML("ml/pmml/test/res/PolynomialRegression.pmml");
    xml data = xml `<data>
                        <salary>20000</salary>
                        <car_location>carpark</car_location>
                    </data>`;
...
function testLogisticRegression () {
    xml pmml = pmml:readFileAsXML("ml/pmml/test/res/LogisticRegression.pmml");
    xml data = xml `<data>
                        <x1>2.7</x1>
                        <x2>2.2</x2>
                    </data>`;
...
function testClassification () {
    xml pmml = pmml:readFileAsXML("ml/pmml/test/res/Classification.pmml");
    xml data = xml `<data>
                        <age>19</age>
                        <work>8</work>
                        <sex>0</sex>
...
function testInteractionTerms () {
    xml pmml = pmml:readFileAsXML("ml/pmml/test/res/InteractionTerms.pmml");
    xml data = xml `<data>
                        <sex>male</sex>
                        <age>19</age>
                        <work>8</work>
...
function testRegressionIrisSetosa () {
    xml pmml = pmml:readFileAsXML("ml/pmml/test/res/RegressionIris.pmml");
    xml data = xml `<data>
...
function testRegressionOzone () {
    xml pmml = pmml:readFileAsXML("ml/pmml/test/res/RegressionOzone.pmml");
    xml data = xml `<data>
                        <temp>30</temp>
                        <ibh>1.21</ibh>
                        <ibt>0.032</ibt>
