...
function executeRegressionFunction(xml pmml, any[] data) {
    ...
    system:println(numberOfNumericPredictors); // TODO find out why this is invalid
    system:println(numericPredictorCoefficients); // TODO find out why this is invalid
